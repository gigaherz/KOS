// Fatten.cpp : Defines the entry point for the console application.
//
#include <stdio.h>
#include <string.h>
#include <Windows.h>
...
int main(int oargc, char* oargv[])
{
	...
	while(argc>0)
	{
		...
		{
			//int fs = 0; // 0=fat12, 1=fat16, 2=fat32 ... whenever I implement those

			// the fs driver detects which FAT format fits best based on size
			NEED_PARAMS(1,1);
...
// 			// Arg 2: fs (optional, default is FAT12)
// 			if(nargs>0)
// 			{
// 				if(_stricmp(argv[0],"fat12")==0)
// 				{
// 					fs=0;
// 				}
// 				else
