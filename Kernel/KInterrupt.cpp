...
ISR_Decl_Handler( 0);	ISR_Decl_Handler( 1);	ISR_Decl_Handler( 2);	ISR_Decl_Handler( 3);
ISR_Decl_Handler( 4);	ISR_Decl_Handler( 5);	ISR_Decl_Handler( 6);	ISR_Decl_Handler( 7);
ISR_Decl_Handler( 8);	ISR_Decl_Handler( 9);	ISR_Decl_Handler(10);	ISR_Decl_Handler(11);
ISR_Decl_Handler(12);	ISR_Decl_Handler(13);	ISR_Decl_Handler(14);	ISR_Decl_Handler(15);
ISR_Decl_Handler(16);	ISR_Decl_Handler(17);	ISR_Decl_Handler(18);	ISR_Decl_Handler(19);
ISR_Decl_Handler(20);	ISR_Decl_Handler(21);	ISR_Decl_Handler(22);	ISR_Decl_Handler(23);
ISR_Decl_Handler(24);	ISR_Decl_Handler(25);	ISR_Decl_Handler(26);	ISR_Decl_Handler(27);
ISR_Decl_Handler(28);	ISR_Decl_Handler(29);	ISR_Decl_Handler(30);	ISR_Decl_Handler(31);

// Interrupts from PIC1
ISR_Decl_Handler(32);	ISR_Decl_Handler(33);	ISR_Decl_Handler(34);	ISR_Decl_Handler(35);
ISR_Decl_Handler(36);	ISR_Decl_Handler(37);	ISR_Decl_Handler(38);	ISR_Decl_Handler(39);

// Interrupts from PIC2
ISR_Decl_Handler(40);	ISR_Decl_Handler(41);	ISR_Decl_Handler(42);	ISR_Decl_Handler(43);
ISR_Decl_Handler(44);	ISR_Decl_Handler(45);	ISR_Decl_Handler(46);	ISR_Decl_Handler(47);
